...
import { UserMenuDropdown } from '@/components/navbar/user_menu';
  ...
  return (
    <div className={'flex items-center justify-between p-5'}>
     ...
     <div className={'flex flex-row items-center gap-2'}>
       {currentUser ? <UserMenuDropdown /> : <Link href={'/auth/login'} >
         <Button className={'text-white'} variant={'default'} size={'sm'}><LogIn className={'text-white'}/> Login</Button>
       </Link>}
       <ModeToggle />
     </div>
    </div>
